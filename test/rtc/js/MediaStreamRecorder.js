...
// Last time updated: 2020-04-26 7:00:07 AM UTC
...
function MultiStreamRecorder(arrayOfMediaStreams, options) {
  ...
  this.start = function (timeSlice) {
    ...
    mediaRecorder = new MediaStreamRecorder(mrs);
...
function MultiStreamsMixer(arrayOfMediaStreams) {
  ...
  function getMixedStream() {
    ...
    console.log(mixedVideoStream);

    console.log(mixedVideoStream.getTracks());

    if (mixedVideoStream.getTracks()[0] !== 'video') {
      console.log('tracks mixed: ', mixedVideoStream.getTracks());
    }
...
var Whammy = (function () {
  ...
  function processInWebWorker(_function) {
    var blob = URL.createObjectURL(
      new Blob([_function.toString(), 'this.onmessage =  function (e) {' + _function.name + '(e.data);}'], {
